...
function StoreBadge({
  ...
  return (
    <Link
      ...
      className="inline-flex h-11 min-w-0 flex-1 items-center gap-2 rounded-lg bg-hello-lime-400 px-3 text-white transition-colors hover:bg-hello-lime-500 sm:h-[3.375rem] sm:flex-none sm:px-4"
    >
      {icon}
...
function AppDownloadHeading() {
  return (
    <h2 className="text-2xl font-bold leading-8 tracking-tight text-gray-900 sm:text-[2rem] sm:leading-10 lg:text-[2.25rem] lg:leading-11 lg:tracking-[-0.02em]">
      From Booking to{" "}
...
export function HomepageAppDownload() {
  return (
    <section
      className="relative overflow-hidden lg:min-h-[25.375rem]"
      style={{
        backgroundImage:
    ...
    >
      ...
      >
        <Logo
          ...
          width={250}
          height={143}
          className="absolute bottom-4 left-0 h-auto w-[18rem] max-w-none opacity-[0.22] sm:bottom-6 sm:w-[22rem] sm:opacity-[0.18] lg:bottom-8 lg:left-2 lg:w-[28rem] lg:opacity-[0.14] xl:w-[32rem]"
        />
      </div>

      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex flex-col gap-8 py-10 sm:gap-10 sm:py-12 lg:grid lg:min-h-[25.375rem] lg:grid-cols-2 lg:items-center lg:gap-12 lg:py-0">
          <div className="relative z-10 mx-auto h-[12.5rem] w-full max-w-[18rem] sm:h-[15.5rem] sm:max-w-[20rem] lg:mx-0 lg:h-[25.375rem] lg:max-w-[31.75rem]">
            <Image
              ...
              width={250}
              height={497}
              className="absolute left-[2%] top-0 z-10 w-[49%] object-contain drop-shadow-[0_8px_24px_rgba(16,24,40,0.12)] lg:-top-20"
            />
            <Image
              ...
              width={262}
              height={497}
              className="absolute bottom-0 left-[47%] z-0 w-[51%] object-contain drop-shadow-[0_8px_24px_rgba(16,24,40,0.12)] lg:bottom-6"
            />
          </div>

          <div className="relative z-10 flex min-w-0 flex-col gap-3 text-left lg:max-w-md lg:justify-self-end">
            <AppDownloadHeading />
            ...
            <div className="mt-1 flex w-full flex-col gap-3 sm:mt-2 sm:flex-row sm:items-center sm:gap-4">
              <StoreBadge
                ...
                icon={<PlayStoreIcon className="size-5 text-white sm:size-7" />}
              />
              <StoreBadge
                href="https://itunes.apple.com/in/app/hello-world-homes/id1481207096"
                topLabel="Get it on"
                bottomLabel="App Store"
                icon={<AppStoreIcon className="size-5 text-white sm:size-7" />}
              />
            </div>
          </div>
        </div>
